        ...
        <Row>
          <Col xs={6} md={{ span: 6, offset: 0 }}>
            <h2 className="h2-main">
              Online booking system to help run your business — Join Today!
            </h2>
            <p>
              Allow booking appointments 24/7 for your clients with our simple
              and easy-to-use API. Grow your business with our user-friendly
              resources and tools.
            </p>
            <Link to="/signup">
