            ...
            <div className="main-container">
                <Jumbotron id="dashboard-jumbotron">
                    <Container>
                        ...
                        <Row>
                            <Col md={{ span: 0, offset: 8 }}><Link to="/add-schedule"><button className="elongated-btn">Add Schedule</button></Link></Col>
                            <Col md={{ span: 0, offset: 0 }}><Link to="/edit-schedule"><button className="elongated-btn">Edit Schedule</button></Link></Col>
